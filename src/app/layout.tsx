...
export const metadata = {
  ...
  openGraph: {
    title:
      " امكو - تنظيف منازل نظافة فلل غسيل شقق نقل اثاث عفش - عزل خزان ‏‎+966 5522 55614‎‏",
    description:
      " تنظيف منازل منزل بالرياض نظافة فلل فيلا شقق شقه واجهة مبنى واجهات مباني عماره عمائر مكتب مكاتب معرض معارض مطعم مطبخ غسيل مجلس مجالس كنب سجاد موكيت عزل خزان خزانات نقل اثاث الاثاث عفش العفش صيانة مكيف مكيفات رش مبيد مبيدات تعقيم مكافحة حشرات بالرياض الرياض",
    ...
    videos: [
      {
        ...
        width: 1280,
        height: 720,
        alt: "فيديو رئيسي من  آمكو النموذجية",
      },
      {
